...
class _FpgrowthMlxtend:
    def __init__(self):
        pass

    @staticmethod
    def do_fpgrowth(data, min_supp):
        t1 = time.time()
        frequent_itemsets = fpgrowth(data, min_support=min_supp, use_colnames=True)
        t2 = time.time()
