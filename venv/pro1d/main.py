...
if inp.lower() == "y" or inp.lower() == "yes":
    ...
    filename_a_association = input("Please name the file for the apriori association rules (without file format extension)")
    ...
    filename_dpg_association = input("Please name the file for the FP=growth association rules (without file format extension)")
